...
export const EDITAR_ROL_PERMISO = gql`
    mutation UpdateRulesPermissionByIdRolPermiso(
        $input: UpdateRulesPermissionByIdRolPermisoInput!
    ) {
...
export const ELIMINAR_ROL_PERMISO = gql`
    mutation DeleteRulesPermissionByIdRolPermiso(
        $input: DeleteRulesPermissionByIdRolPermisoInput!
    ) {
...
export const CREAR_USER_STORY = gql`
    mutation Mutation($input: CreateUsersStoryInput!) {
        createUsersStory(input: $input) {
            usersStory {
                idBacklog
                idEstado
                idUserStory
